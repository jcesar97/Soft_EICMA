...
<body class="hold-transition sidebar-mini">
          ...
          <div class="row">
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header d-block">
                    <h3 class="modal-title text-center" id="addModal">Agregar servicio</h3>

                  </div>
                  <div class="modal-body">
                    <form id="addServicio" name="addServicio" action="<?php echo site_url('Nom_Servicios/add'); ?>" method="post">
                      <div class="row">
                        ...
                        <div class="col-12">
                          ...
                          <select id="id_uni_med" name="id_uni_med" class="form-control">
                            <option selected>Seleccione unidad de medida</option>
                            <?php foreach ($uni_med as $key) : ?>
                              <option value="<?= $key['id_uni_med']; ?>"><?= $key['sigla']; ?></option>
                            <?php endforeach; ?>
                          </select>
                        </div>
                      </div>
            ...
            <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true" role="dialog">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header d-block">
                    <h3 class="modal-title text-center" id="updateModal">Actualizar servicio</h3>
                  </div>
                  <div class="modal-body">
                    <form id="updateServicio" name="updateServicio" action="<?php echo site_url('Nom_Servicios/update'); ?>" method="post">
            ...
            <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="showModalLabel" aria-hidden="true" role="dialog">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header d-block">
                    <h3 class="modal-title text-center" id="showModal">Detalles del servicio</h3>
                  </div>
                  <div class="modal-body">
                    <form id="showServicio" name="showServicio" action="<?php echo site_url('Nom_Servicios/show'); ?>" method="post">
                      <input type="hidden" name="id_servicio" id="id_servicio" />
                      <div class="row">
                        <div class="col-12 col-sm-6">
                          <div class="form-group">
                        ...
                        <div class="col-12">
                          ...
                          <select id="sigla" name="sigla" class="form-control">
                            <option selected>Seleccione unidad de medida</option>
                            <?php foreach ($uni_med as $key => $uni_med) : ?>
                              <option disabled value="<?= $uni_med['id_uni_med']; ?>"><?= $uni_med['sigla']; ?></option>
                            <?php endforeach; ?>
                          </select>
                        </div>
                      </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    <th class="text-sm-center">Unidad de medida</th>
                ...
                <tbody>
                  <?php foreach ($servicios as $key) : ?>
                    <tr id_area="<?php echo $key['id_servicio']; ?>">
                      <td class="text-sm-center"><?php echo $key['uni_nom']; ?></td>
                      <td class="text-sm-center"><?php echo $key['codigo']; ?></td>
                      <td class="text-sm-center"><?php echo $key['nombre']; ?></td>
                      <td class="text-sm-center">
                        <button title="Editar" data-id="<?php echo $key['id_servicio']; ?>" class="btn btn-warning btnEdit"><span class="fa fa-edit"></span></button>
                        <button title="Eliminar" data-id="<?php echo $key['id_servicio']; ?>" class="btn btn-danger btnDelete"><span class="fa fa-times"></span></button>
                        <button title="Detalles" data-id="<?php echo $key['id_servicio']; ?>" class="btn btn-primary btnShow"><span class="fa fa-search-plus"></span></button>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
  ...
  <!-- Carga js servicios -->
  <script src="<?= base_url() ?>/public/tema_tesis/dist/js/cruds/servicios.js"></script>
