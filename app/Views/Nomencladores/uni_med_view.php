...
<body class="hold-transition sidebar-mini">
          ...
          <div class="row">
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header d-block">
                    <h3 class="modal-title text-center" id="addModal">Agregar unidad de medida</h3>

                  </div>
                  <div class="modal-body">
                    <form id="addUni_med" name="addUni_med" action="<?php echo site_url('Nom_Uni_medida/add'); ?>" method="post">
                      <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                          <div class="form-group">
                            ...
                            <input required type="text" name="sigla" class="form-control sigla" id="sigla" placeholder="Sigla">
                          </div>
                        </div>
                      </div>
            ...
            <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true" role="dialog">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header d-block">
                    <h3 class="modal-title text-center" id="updateModal">Actualizar unidad de medida</h3>
                  </div>
                  <div class="modal-body">
                    <form id="updateUni_med" name="updateUni_med" action="<?php echo site_url('Nom_Uni_medida/update'); ?>" method="post">
                      <input type="hidden" name="id_uni_med" id="id_uni_med" />
                      <div class="row">
                        <div class="col-12 col-sm-6">
                          <div class="form-group">
                            <label for="text">Nombre:</label>
                        ...
                        <div class="col-12 col-sm-6">
                          <div class="form-group">
                            <label for="text">Sigla:</label>
                            <input type="text" name="sigla" class="form-control sigla" id="sigla" placeholder="Sigla">
                          </div>
                        </div>
                      </div>
                      <div class="modal-footer justify-content-center">
            ...
            <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="showModalLabel" aria-hidden="true" role="dialog">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header d-block">
                    <h3 class="modal-title text-center" id="showModal">Detalles de la unidad de medida</h3>
                  </div>
                  <div class="modal-body">
                    <form id="showUni_med" name="showUni_med" action="<?php echo site_url('Nom_Uni_medida/show'); ?>" method="post">
                      <input type="hidden" name="id_uni_med" id="id_uni_med" />
                      <div class="row">
                        <div class="col-12">
                          <div class="form-group">
                        ...
                        <div class="col-12">
                          <div class="form-group">
                            <label for="text">Sigla:</label>
                            <input type="text" disabled name="sigla" class="form-control sigla" id="sigla" placeholder="Sigla">
                          </div>
                        </div>
                      </div>
                      <div class="modal-footer justify-content-center">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php foreach ($uni_med as $row) : ?>
                    <tr id_area="<?php echo $row['id_uni_med']; ?>">
                      <td class="text-sm-center"><?php echo $row['nombre']; ?></td>
                      <td class="text-sm-center"><?php echo $row['sigla']; ?></td>
                      <td class="text-sm-center">
                        <button title="Editar" data-id="<?php echo $row['id_uni_med']; ?>" class="btn btn-warning btnEdit"><span class="fa fa-edit"></span></button>
                        <button title="Eliminar" data-id="<?php echo $row['id_uni_med']; ?>" class="btn btn-danger btnDelete"><span class="fa fa-times"></span></button>
                        <button title="Detalles" data-id="<?php echo $row['id_uni_med']; ?>" class="btn btn-primary btnShow"><span class="fa fa-search-plus"></span></button>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
  ...
  <!-- Page specific script -->
   <!-- Carga js uni_med -->
   <script src="<?= base_url() ?>/public/tema_tesis/dist/js/cruds/uni_med.js"></script>
