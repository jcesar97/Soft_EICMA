...
<body class="hold-transition sidebar-mini">
          ...
          <div class="row">
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header d-block">
                      <h3 class="modal-title text-center" id="addModal">Agregar departamento</h3>

                    </div>
                    <div class="modal-body">
                      <form id="addDepartamento" name="addDepartamento" action="<?php echo site_url('Nom_Departamentos/add'); ?>" method="post">
                        <div class="row">
                          <div class="col-12 col-sm-6">
                            <div class="form-group">
                              <label for="text" >Código:</label>
                              <input required type="number" required name="codigo" class="form-control codigo" id="codigo" placeholder="Codigo">
                            </div>
                          </div>
                          <div class="col-12 col-sm-6">
                            <div class="form-group">
                              <label for="text">Nombre:</label>
                              <input required type="text" required name="nombre" class="form-control nombre" id="nombre" placeholder="Nombre">
                            </div>
                          </div>
                        </div>
                        <div class="modal-footer justify-content-center">
                          <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
                          <button type="submit" id="toast" class="btn btn-success fa fa-floppy">Guardar</button>
                        </div>
                      </form>
                    </div>
                  </div>
              ...
              <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true" role="dialog">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header d-block">
                      <h3 class="modal-title text-center" id="updateModal">Actualizar departamento</h3>
                    </div>
                    <div class="modal-body">
                      <form id="updateDepartamento" name="updateDepartamento" action="<?php echo site_url('Nom_Departamentos/update'); ?>" method="post">
                        <input type="hidden" name="id_area" id="id_area" />
                        <div class="row">
                          <div class="col-12 col-sm-6">
                            <div class="form-group">
                              <label for="text">Código:</label>
                              <input type="number" required name="codigo" class="form-control codigo" id="codigo" placeholder="Codigo">
                            </div>
                          </div>
                          <div class="col-12 col-sm-6">
                            <div class="form-group">
                              <label for="text">Nombre:</label>
                              <input type="text" required name="nombre" class="form-control nombre" id="nombre" placeholder="Nombre">
                            </div>
                          </div>
                        </div>
                        <div class="modal-footer justify-content-center">
              ...
              <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="showModalLabel" aria-hidden="true" role="dialog">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header d-block">
                      <h3 class="modal-title text-center" id="showModal">Detalles del departamento</h3>
                    </div>
                    <div class="modal-body">
                      <form id="showDepartamento" name="showDepartamento" action="<?php echo site_url('Nom_Departamentos/show'); ?>" method="post">
                        <input type="hidden" name="id_area" id="id_area" />
                        <div class="row">
                          <div class="col-12 col-sm-6">
                            <div class="form-group">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table id="example" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php foreach ($deparamentos as $row) : ?>
                        <tr id_area="<?php echo $row['id_area']; ?>">
                          <td class="text-sm-center"><?php echo $row['codigo']; ?></td>
                          <td class="text-sm-center"><?php echo $row['nombre']; ?></td>
                          <td class="text-sm-center">
                            <button title="Editar" data-id="<?php echo $row['id_area']; ?>" class="btn btn-warning btnEdit"><span class="fa fa-edit"></span></button>
                            <button title="Eliminar" data-id="<?php echo $row['id_area']; ?>" class="btn btn-danger btnDelete"><span class="fa fa-times"></span></button>
                            <button title="Detalles" data-id="<?php echo $row['id_area']; ?>" class="btn btn-primary btnShow"><span class="fa fa-search-plus"></span></button>  
                          </td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
  ...
  <!-- Carga js departamentos -->
  <script src="<?= base_url() ?>/public/tema_tesis/dist/js/cruds/departamentos.js"></script>
...
<script>
  ...
  indice = document.getElementById("codigo").selectedIndex;
  if (indice == null || indice == 0 {
    alert('[ERROR] Escriba un codigo valido');
    return false;
  }
