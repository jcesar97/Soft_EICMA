...
<body class="hold-transition sidebar-mini">
        ...
        <div class="container-fluid">
            ...
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                <div class="modal-header d-block">
                  <h3 class="modal-title text-center" id="addModal">Agregar técnico</h3>

                </div>
                <div class="modal-body">
                  <form id="addTecnico" name="addTecnico" action="<?php echo site_url('Nom_Tecnicos/add'); ?>" method="post">
                    <div class="row">
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
                          <label for="text">Carnet:</label>
                          <input required type="text" name="carnet" class="form-control codigo" id="carnet" placeholder="Carnet">
                        </div>
                      </div>
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
          ...
          <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true" role="dialog">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                <div class="modal-header d-block">
                  <h3 class="modal-title text-center" id="updateModal">Actualizar Técnico</h3>
                </div>
                <div class="modal-body">
                  <form id="updateTecnico" name="updateTecnico" action="<?php echo site_url('Nom_Tecnicos/update'); ?>" method="post">
                    <input type="hidden" name="id_tecnico" id="id_tecnico" />
                    <div class="row">
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
                          <label for="text">Código:</label>
                          <input type="text" name="carnet" class="form-control codigo" id="carnet" placeholder="Carnet">
                        </div>
                      </div>
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
          ...
          <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="showModalLabel" aria-hidden="true" role="dialog">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                <div class="modal-header d-block">
                  <h3 class="modal-title text-center" id="showModal">Detalles del Técnico</h3>
                </div>
                <div class="modal-body">
                  <form id="showTecnico" name="showTecnico" action="<?php echo site_url('Nom_Tecnicos/show'); ?>" method="post">
                    <input type="hidden" name="id_tecnico" id="id_tecnico" />
                    <div class="row">
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
                          <label for="text">Código:</label>
                          <input type="text" disabled name="carnet" class="form-control codigo" id="carnet" placeholder="Carnet">
                        </div>
                      </div>
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <table id="example" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th class="text-sm-center">ÁREA</th>
                  <th class="text-sm-center">Carnet</th>
              ...
              <tbody>
                <?php foreach ($tecnicos as $row) : ?>
                  <tr id_area="<?php echo $row['id_tecnico']; ?>">
                    <td class="text-sm-center"><?php echo $row['area']; ?></td>
                    <td class="text-sm-center"><?php echo $row['carnet']; ?></td>
                    <td class="text-sm-center"><?php echo $row['nombre']; ?></td>
                    <td class="text-sm-center">
                      <button title="Editar" data-id="<?php echo $row['id_tecnico']; ?>" class="btn btn-warning btnEdit"><span class="fa fa-edit"></span></button>
                      <button title="Eliminar" data-id="<?php echo $row['id_tecnico']; ?>" class="btn btn-danger btnDelete"><span class="fa fa-times"></span></button>
                      <button title="Detalles" data-id="<?php echo $row['id_tecnico']; ?>" class="btn btn-primary btnShow"><span class="fa fa-search-plus"></span></button>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
 ...
 -->
  ...
  <!-- Carga js tecnicos -->
  <script src="<?= base_url() ?>/public/tema_tesis/dist/js/cruds/tecnicos.js"></script>
