...
<body class="hold-transition sidebar-mini">
          ...
          <div class="row">
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header d-block">
                    <h3 class="modal-title text-center" id="addModal">Agregar frecuencia</h3>

                  </div>
                  <div class="modal-body">
                    <form id="addFrecuencia" name="addFrecuencia" action="<?php echo site_url('Nom_Frecuencia/add'); ?>" method="post">
                      <div class="row">
                        <div class="col-12 ">
            ...
            <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true" role="dialog">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header d-block">
                    <h3 class="modal-title text-center" id="updateModal">Actualizar frecuencia</h3>
                  </div>
                  <div class="modal-body">
                    <form id="updateFrecuencia" name="updateFrecuencia" action="<?php echo site_url('Nom_Frecuencia/update'); ?>" method="post">
                      <input type="hidden" name="id_frecuencia" id="id_frecuencia" />
                      <div class="row">
                        <div class="col-12">
                          <div class="form-group">
                            <label for="text">Nombre:</label>
            ...
            <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="showModalLabel" aria-hidden="true" role="dialog">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form id="showFrecuencia" name="showFrecuencia" action="<?php echo site_url('Nom_Frecuencia/show'); ?>" method="post">
                      <input type="hidden" name="id_frecuencia" id="id_frecuencia" />
                      <div class="row">
                        <div class="col-12">
                          <div class="form-group">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php foreach ($frecuencia as $row) : ?>
                    <tr id_area="<?php echo $row['id_frecuencia']; ?>">
                      <td class="text-sm-center"><?php echo $row['nombre']; ?></td>
                      <td class="text-sm-center">
                      <button title="Editar" data-id="<?php echo $row['id_frecuencia']; ?>" class="btn          btn-warning btnEdit"><span class="fa fa-edit"></span></button>
                            <button title="Eliminar" data-id="<?php echo $row['id_frecuencia']; ?>" class="btn btn-danger btnDelete"><span class="fa fa-times"></span></button>
                            <button title="Detalles" data-id="<?php echo $row['id_frecuencia']; ?>" class="btn btn-primary btnShow"><span class="fa fa-search-plus"></span></button> 
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
  ...
  <!-- Carga js frecuencia -->
  <script src="<?= base_url() ?>/public/tema_tesis/dist/js/cruds/frecuencia.js"></script>
