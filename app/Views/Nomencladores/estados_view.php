...
<body class="hold-transition sidebar-mini">
          ...
          <div class="row">
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header d-block">
                    <h3 class="modal-title text-center" id="addModal">Agregar estado</h3>

                  </div>
                  <div class="modal-body">
                    <form id="addEstado" name="addEstado" action="<?php echo site_url('Nom_Estados/add'); ?>" method="post">
                      <div class="row">
                        <div class="col-12 ">
            ...
            <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true" role="dialog">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header d-block">
                    <h3 class="modal-title text-center" id="updateModal">Actualizar estado</h3>
                  </div>
                  <div class="modal-body">
                    <form id="updateEstado" name="updateEstado" action="<?php echo site_url('Nom_Estados/update'); ?>" method="post">
            ...
            <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="showModalLabel" aria-hidden="true" role="dialog">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header d-block">
                    <h3 class="modal-title text-center" id="showModal">Detalles del estado</h3>
                  </div>
                  <div class="modal-body">
                    <form id="showEstado" name="showEstado" action="<?php echo site_url('Nom_Estados/show'); ?>" method="post">
                      <input type="hidden" name="id_estado" id="id_estado" />
                      <div class="row">
                        <div class="col-12">
                          <div class="form-group">
              ...
              <table id="example" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php foreach ($estados as $row) : ?>
                    <tr id_area="<?php echo $row['id_estado']; ?>">
                      <td class="text-sm-center"><?php echo $row['nombre']; ?></td>
                      <td class="text-sm-center">
                        <button title="Editar" data-id="<?php echo $row['id_estado']; ?>" class="btn btn-warning btnEdit"><span class="fa fa-edit"></span></button>
                        <button title="Eliminar" data-id="<?php echo $row['id_estado']; ?>" class="btn btn-danger btnDelete"><span class="fa fa-times"></span></button>
                        <button title="Detalles" data-id="<?php echo $row['id_estado']; ?>" class="btn btn-primary btnShow"><span class="fa fa-search-plus"></span></button>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
  ...
  <!-- Carga js estados -->
  <script src="<?= base_url() ?>/public/tema_tesis/dist/js/cruds/estados.js"></script>
