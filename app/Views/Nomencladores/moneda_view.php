...
<body class="hold-transition sidebar-mini">
          ...
          <div class="row">
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header d-block">
                    <h3 class="modal-title text-center" id="addModal">Agregar moneda</h3>

                  </div>
                  <div class="modal-body">
                    <form id="addMoneda" name="addMoneda" action="<?php echo site_url('Nom_Moneda/add'); ?>" method="post">
                      <div class="row">
            ...
            <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true" role="dialog">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header d-block">
                    <h3 class="modal-title text-center" id="updateModal">Actualizar moneda</h3>
                  </div>
                  <div class="modal-body">
                    <form id="updateMoneda" name="updateMoneda" action="<?php echo site_url('Nom_Moneda/update'); ?>" method="post">
            ...
            <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="showModalLabel" aria-hidden="true" role="dialog">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header d-block">
                    <h3 class="modal-title text-center" id="showModal">Detalles de la frecuencia</h3>
                  </div>
                  <div class="modal-body">
                    <form id="showMoneda" name="showMoneda" action="<?php echo site_url('Nom_Frecuencia/show'); ?>" method="post">
                      <input type="hidden" name="id_moneda" id="id_moneda" />
                      <div class="row">
                        <div class="col-12">
                          <div class="form-group">
              ...
              <table id="example" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php foreach ($moneda as $row) : ?>
                    <tr id_area="<?php echo $row['id_moneda']; ?>">
                      <td class="text-sm-center"><?php echo $row['nombre']; ?></td>
                      <td class="text-sm-center"><?php echo $row['sigla']; ?></td>
                      <td class="text-sm-center">
                        <button title="Editar" data-id="<?php echo $row['id_moneda']; ?>" class="btn btn-warning btnEdit"><span class="fa fa-edit"></span></button>
                        <button title="Eliminar" data-id="<?php echo $row['id_moneda']; ?>" class="btn btn-danger btnDelete"><span class="fa fa-times"></span></button>
                        <button title="Detalles" data-id="<?php echo $row['id_moneda']; ?>" class="btn btn-primary btnShow"><span class="fa fa-search-plus"></span></button>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
  ...
  <!-- Carga js moneda -->
  <script src="<?= base_url() ?>/public/tema_tesis/dist/js/cruds/moneda.js"></script>
